...
public class Client implements ActionListener {
    ...
    static DataOutputStream dout;
     ...
     // to set profile pic  on panel 
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/2.png")); // address of image
     ...
     // main frame 
       f.setSize(450, 650);
       f.setLocation(800, 50);  //only change the locatoin of the frame on display(200->800)
      ...
      new Client();
       ...
       try{
         ...
         while(true){
           ...
           vertical.add(Box.createVerticalStrut(10)); //10
           a1.add(vertical, BorderLayout.PAGE_START); 
